...
class ClassifyingActivity : AppCompatActivity() {
    ...
    private val physical_model by lazy {
        Model(Interpreter(
            ...
            6, 50, listOf(-0.05189358348056579, -0.5048876413356554, 0.05859989689250257, -0.37909157061017584, -0.03498028895952492, 0.09736756590302814) , listOf(0.4820750778167604, 0.5325584313111044, 0.5596284512414832, 0.5780678958522251, 0.5214528252401204, 0.6246849109574315))
    }
